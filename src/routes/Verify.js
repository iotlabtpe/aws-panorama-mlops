...
class  Verify extends React.Component {
  ...
  render(){
    const c = (<ImgCard {...this.props} history={this.props.history} />)
    return  <FrameLayout breadcrumb="Verify" component={c} />
  }

}

export default connect(mapStateToProps,MapDispatchTpProps)(withTranslation()(Verify));
