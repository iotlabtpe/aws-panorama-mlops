...
class  ExportDataSet extends React.Component {
  ...
  render(){
    const c = (<ExportDataSetForm history={this.props.history} />)
    return  <FrameLayout breadcrumb="ExportDataSet" component={c} />
  }

}

export default connect(mapStateToProps,MapDispatchTpProps)(withTranslation()(ExportDataSet));
