...
import DeviceCfgTable from '../components/DeviceCfgTable'
...
class  DeviceCfgList extends React.Component {
  ...
  render(){
    ...
    return  <FrameLayout breadcrumb="DeviceCfgList" component={c} />
  }
}

export default connect(mapStateToProps,MapDispatchTpProps)(withTranslation()(DeviceCfgList));
