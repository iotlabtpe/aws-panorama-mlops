...
import NewStoredApplicationForm from '../components/NewStoredApplicationForm';
...
class NewStoredApplicationConfig extends React.Component {
...
export default connect(mapStateToProps,MapDispatchTpProps)(withTranslation()(NewStoredApplicationConfig));
