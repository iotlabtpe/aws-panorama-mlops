...
class  CloneModelConfig extends React.Component {
  ...
  render(){
    ...
    return  <FrameLayout breadcrumb="CloneModelConfig" component={c} />
  }
}

export default connect(mapStateToProps,MapDispatchTpProps)(withTranslation()(CloneModelConfig));
